...
| 最佳实践主题 | AI 学习的关键点 |
|-------------|----------------|
| **交互设计** | 手势时长（长按500ms）、点击热区（≥48vp）、响应反馈 |
| **视觉设计** | 色彩对比度（>4.5:1）、字体层级（标题/正文/辅助）、图标规范 |
| **动效设计** | 转场时长（≥200ms）、曲线选择（弹簧曲线优先）、跟手性 |
| **布局设计** | 响应式适配、挖孔区避让、安全区域处理 |
| **无障碍设计** | 辅助功能支持、高对比度模式、字体缩放 |

**AI 提取并应用的规范**:

```typescript
// Constants.ets - 基于设计最佳实践定义的常量
export const UI_CONFIG = {
  // 来自 2.1.3.2 手势时长规范
  LONG_PRESS_DURATION: 500,  // 长按时长 400-650ms

  // 来自 2.1.3.3 点击热区规范
  MIN_TOUCH_TARGET: 48,  // 最小点击热区 48vp

  // 来自 2.1.4.2 字体大小规范
  MIN_FONT_SIZE: 12,  // 正文最小字体 12vp
  BODY_FONT_SIZE: 14,  // 正文推荐字体 14vp

  // 来自 2.1.5.2.2 动效时长规范
  PAGE_TRANSITION_DURATION: 300,  // 页面转场 ≥200ms
};
```
